...
func TestBuildCommandRouter_EndToEnd(t *testing.T) {
	...
	router := buildCommandRouter(tenant, pitySys, streakSys, customStore, timerStore, quoteStore, counterStore, liveopsStore, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, logger)
