...
1. [`CODE_OF_CONDUCT.md`](CODE_OF_CONDUCT.md) - Contributor Covenant 2.1.
2. This file - the rest.
...
```bash
git clone https://github.com/Luca-Pelzer/engelos
cd engelos
...
Use [GitHub Discussions](https://github.com/Luca-Pelzer/engelos/discussions)
