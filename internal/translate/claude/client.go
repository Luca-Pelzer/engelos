...
// [WithAPIKey] (or the ENGELOS_ANTHROPIC_API_KEY env var wired in main).
// Override the endpoint via [WithBaseURL] to point at a compatible proxy or an
...
// WithAPIKey sets your Anthropic API key, sent as the x-api-key header. When
// unset no key header is sent. An empty value is ignored.
