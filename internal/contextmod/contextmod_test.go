...
func TestClassify_BackendErrorFailsOpen(t *testing.T) {
	...
	d := e.Classify(context.Background(), "rules", "u", "some judgeable message here")
...
func TestClassify_GlobalRateLimit(t *testing.T) {
	...
	d1 := e.Classify(context.Background(), "rules", "u", "first judgeable message")
	d2 := e.Classify(context.Background(), "rules", "u", "second judgeable message")
	if !d1.Consulted {
